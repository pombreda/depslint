...
class Results(object):
  ...
  class _TouchedObject(object):
    ...
    def __init__(self, root, path, tainted, size, nb_files):
      ...
      # particular, once self.tainted is True, like the path was replaced with a
      # variable, it is not possible to look up the file size.
      self._size = size
  ...
  class Context(object):
    ...
    class Process(object):
      ...
      def to_results_process(self):
        ...
        # multiple entries with the sa#me path but different modes.
        rendered = (
